  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return ScrollablePositionedList.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return Opacity(
          opacity: now.isAfter(time) && nowMinute ~/ 30 != index ? .5 : 1,
          child: Row(
            children: [
              Expanded(
                child: Center(
                      ...
                      return notes.when(
                          data: (data) {
                            ...
                            return AnimatedContainer(
                              ...
                              color: blockNotes.isNotEmpty ? const Color.fromARGB(200, 155, 233, 168) : null,
                              padding: const EdgeInsets.all(4),
                              child: blockNotes.isNotEmpty && blockNotes.first.startDate == time
                                  ? Row(
                                      children: [
                                        Expanded(child: Text(blockNotes.first.text ?? 'bad')),
                                        IconButton(
                                            onPressed: () =>
